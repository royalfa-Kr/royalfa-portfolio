      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="flex items-center gap-1 md:gap-4 overflow-x-auto custom-scrollbar px-2 mx-auto">
            ...
            <Link href="/clases#resenas" className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-slate-300 hover:text-accent-gold hover:bg-slate-900 rounded-lg transition-all whitespace-nowrap">
