  ...
  return (
    <div className="flex flex-col items-start gap-6">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 pt-4 w-full sm:w-auto">
        <Link href="/clases" className="w-full sm:w-auto flex items-center justify-center gap-2 bg-accent-gold text-base-dark px-8 py-3 rounded-sm font-semibold hover:bg-accent-goldHover transition-colors">
          Agendar Asesoría 1a1
        </Link>
        <Link href="/apps" className="w-full sm:w-auto flex items-center justify-center gap-2 bg-transparent border border-accent-gold/50 text-accent-gold px-8 py-3 rounded-sm font-semibold hover:bg-accent-gold/10 transition-colors">
          Explorar Proyectos
        </Link>
      </div>
    </div>
